...
import {UniswapV4ERC20} from "./uniswap-v4-periphery/libraries/UniswapV4ERC20.sol";
import {FixedPoint96} from "./uniswap-v4-core/libraries/FixedPoint96.sol";
import {FixedPointMathLib} from "./lib/solmate/utils/FixedPointMathLib.sol";
...
contract AIRangeHook is BaseHook {
    ...
    returns (bytes4)
    {
        ...
        return AIRangeHook.beforeInitialize.selector;
    }
    ...
    function beforeAddLiquidity(
        ...
        return AIRangeHook.beforeAddLiquidity.selector;
    }
